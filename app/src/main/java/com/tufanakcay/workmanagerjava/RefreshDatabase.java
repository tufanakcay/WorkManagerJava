package com.tufanakcay.workmanagerjava;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase(int myNumber) {
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.tufanakcay.workmanagerjava",Context.MODE_PRIVATE);
